 ...
 * Lab 2 part 3
 * Description: line following Harabot using IR sensors 
 * 
 */
 ...
 int pd_controller(int16_t error) {
  ...
  // will want to make sure that we can properly pass on the previous error

  // Calculate the PD command relative to the stop bias
